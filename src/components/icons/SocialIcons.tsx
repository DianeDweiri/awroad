export function InstagramIcon({ size = 20, color = '#A78BFA' }: { size?: number; color?: string }) {
  return (
...
export function FacebookIcon({ size = 20, color = '#A78BFA' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function YoutubeIcon({ size = 20, color = '#A78BFA' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
