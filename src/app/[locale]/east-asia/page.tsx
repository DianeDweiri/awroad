...
const t = {
  en: { eyebrow: '— Regional Office —', title: 'East Asia Regional Node & Chinese Language Expertise Centre', country: 'China', body: 'The East Asia Regional Node and Chinese Language Expertise Centre is hosted in China. It coordinates astronomy for development activities across East Asia and supports the development of astronomical content in the Chinese language, connecting the region with the global IAU Office of Astronomy for Development network.' },
  ar: { eyebrow: '— مكتب إقليمي —', title: 'مركز شرق آسيا الإقليمي ومركز خبرة اللغة الصينية', country: 'الصين', body: 'يستضاف مركز شرق آسيا الإقليمي ومركز خبرة اللغة الصينية في الصين. يقوم بتنسيق أنشطة علم الفلك من أجل التنمية في منطقة شرق آسيا ويدعم تطوير المحتوى الفلكي باللغة الصينية، ليربط المنطقة بشبكة مكتب الاتحاد الفلكي الدولي لعلم الفلك من أجل التنمية.' },
};
export default function EastAsiaPage() {
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '160px 0 100px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 28px' }} dir={isRtl ? 'rtl' : 'ltr'}>
          ...
          <div style={{ borderRadius: 18, overflow: 'hidden', marginBottom: 36, border: '1px solid rgba(79,126,255,0.15)' }}>
            <img src="/ROADS/east-asia.jpg" alt={tx.title} style={{ width: '100%', display: 'block', maxHeight: 400, objectFit: 'cover' }} />
          </div>
