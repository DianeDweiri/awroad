...
const t = {
  en: {
    ...
    emptyTitle: 'Something new is on the way',
    emptyBody: "We're preparing our first insights — stories, updates, and perspectives from across the network. Check back soon.",
  },
  ar: {
    eyebrow: '— مقالات —',
    title: 'أحدث المقالات',
    emptyTitle: 'شيء جديد قادم قريباً',
    emptyBody: 'نعمل على إعداد أولى مقالاتنا — قصص وتحديثات ووجهات نظر من شبكتنا. تابعونا قريباً.',
  },
};
